...
import org.msl.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleSubNodeReference2ItemSemanticEditPolicy;
			...
			parser = SimplemapParserProvider
					.getParser(
							...
							SimplemapVisualIDRegistry
									.getType(org.msl.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleSubNodeReference2EditPart.VISUAL_ID));
		}
		return parser;
	}
