 ...
 * @generated
 */
public class ParentSubNodeLabel2EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				SimplemapVisualIDRegistry
						.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.ParentSubNodeLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ParentSubNodeLabel2EditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new InputLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InputLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InputLabelFigure() {
			this.setText("<<in>>");
		}
