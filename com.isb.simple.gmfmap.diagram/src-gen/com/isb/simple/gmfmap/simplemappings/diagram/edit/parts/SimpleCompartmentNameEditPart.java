 ...
 * @generated
 */
public class SimpleCompartmentNameEditPart extends CompartmentEditPart
			...
			parser = SimplemapParserProvider
					.getParser(
							...
							SimplemapVisualIDRegistry
									.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleCompartmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
