...
import com.isb.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleCompartment2CanonicalEditPolicy;
import com.isb.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleCompartment2ItemSemanticEditPolicy;
import com.isb.simple.gmfmap.simplemappings.diagram.part.SimplemapVisualIDRegistry;

/**
 * @generated
 */
public class SimpleCompartment2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SimpleCompartment2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimpleCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new SimpleCompartment2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SimpleCompartmentName2EditPart) {
			((SimpleCompartmentName2EditPart) childEditPart)
