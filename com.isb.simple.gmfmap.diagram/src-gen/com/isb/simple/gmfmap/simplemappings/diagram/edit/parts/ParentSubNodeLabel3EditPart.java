 ...
 * @generated
 */
public class ParentSubNodeLabel3EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				SimplemapVisualIDRegistry
						.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.ParentSubNodeLabel3EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ParentSubNodeLabel3EditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new OutputLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OutputLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OutputLabelFigure() {
			this.setText("<<out>>");
		}
