 ...
 * @generated
 */
public class SimpleLinkMappingOutputsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SimpleLinkMappingOutputsCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof SimpleLinkMapping) {
			return false;
		}
		...
		return SimplemapBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateSimpleLinkMappingOutputs_4004(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getOutputs().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected SimpleLinkMapping getSource() {
		return (SimpleLinkMapping) source;
	}
