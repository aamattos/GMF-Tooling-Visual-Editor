...
import com.isb.simple.gmfmap.simplemappings.diagram.part.SimplemapDiagramUpdater;
import com.isb.simple.gmfmap.simplemappings.diagram.part.SimplemapLinkDescriptor;
import com.isb.simple.gmfmap.simplemappings.diagram.part.SimplemapNodeDescriptor;
...
public class SimpleMappingCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<SimplemapNodeDescriptor> childDescriptors = SimplemapDiagramUpdater
				.getSimpleMapping_1000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SimpleTopNodeEditPart.VISUAL_ID
				|| visualID == SimpleSubNodeEditPart.VISUAL_ID
				|| visualID == SimpleLinkMappingEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<SimplemapNodeDescriptor> childDescriptors = SimplemapDiagramUpdater
				.getSimpleMapping_1000SemanticChildren((View) getHost()
						.getModel());
		...
		for (Iterator<SimplemapNodeDescriptor> descriptorsIterator = childDescriptors
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<SimplemapLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = SimplemapVisualIDRegistry
			...
			for (Iterator<SimplemapLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				SimplemapLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<SimplemapLinkDescriptor> collectAllLinks(View view,
		...
		case SimpleMappingEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SimplemapDiagramUpdater
						.getSimpleMapping_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case SimpleTopNodeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SimplemapDiagramUpdater
						.getSimpleTopNode_2003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case SimpleSubNodeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SimplemapDiagramUpdater
						.getSimpleSubNode_2006ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case SimpleLinkMappingEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SimplemapDiagramUpdater
						.getSimpleLinkMapping_2007ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case SimpleCompartmentEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SimplemapDiagramUpdater
						.getSimpleCompartment_3005ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case SimpleCompartment2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SimplemapDiagramUpdater
						.getSimpleCompartment_3019ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection<IAdaptable> createConnections(
			Collection<SimplemapLinkDescriptor> linkDescriptors,
			Map<EObject, View> domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (SimplemapLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					SimplemapVisualIDRegistry.getType(nextLinkDescriptor
