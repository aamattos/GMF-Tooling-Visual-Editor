...
import com.isb.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleSubNodeReference2ItemSemanticEditPolicy;
import com.isb.simple.gmfmap.simplemappings.diagram.edit.policies.SimplemapTextNonResizableEditPolicy;
 ...
 * @generated
 */
public class SimpleSubNodeReference2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SimpleSubNodeReference2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimpleSubNodeReference2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new SimplemapTextNonResizableEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplemapParserProvider
					.getParser(
							SimplemapElementTypes.SimpleSubNodeReference_3012,
							getParserElement(),
							SimplemapVisualIDRegistry
									.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleSubNodeReference2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					SimplemapEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new SimpleTopNodeReferenceFigure();
	}

	/**
	 * @generated
	 */
	public class SimpleTopNodeReferenceFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SimpleTopNodeReferenceFigure() {
			this.setText("");
