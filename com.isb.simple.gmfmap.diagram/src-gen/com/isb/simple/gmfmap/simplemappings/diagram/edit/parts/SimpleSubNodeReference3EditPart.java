...
import com.isb.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleSubNodeReference3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SimpleSubNodeReference3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SimpleSubNodeReference3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimpleSubNodeReference3ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplemapParserProvider
					.getParser(
							SimplemapElementTypes.SimpleSubNodeReference_3016,
							getParserElement(),
							SimplemapVisualIDRegistry
									.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleSubNodeReference3EditPart.VISUAL_ID));
		}
		return parser;
	}
