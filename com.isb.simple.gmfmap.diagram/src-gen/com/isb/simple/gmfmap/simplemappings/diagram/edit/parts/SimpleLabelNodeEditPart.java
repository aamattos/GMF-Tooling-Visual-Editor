...
import com.isb.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleLabelNodeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SimpleLabelNodeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimpleLabelNodeItemSemanticEditPolicy());
			...
			parser = SimplemapParserProvider
					.getParser(
							...
							SimplemapVisualIDRegistry
									.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleLabelNodeEditPart.VISUAL_ID));
		}
		return parser;
	}
