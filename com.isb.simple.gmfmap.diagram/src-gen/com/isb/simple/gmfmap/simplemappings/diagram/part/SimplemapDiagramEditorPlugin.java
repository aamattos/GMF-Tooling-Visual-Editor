...
import com.isb.simple.gmfmap.simplemappings.diagram.providers.ElementInitializers;
import com.isb.simple.gmfmap.simplemappings.provider.SimplemappingsItemProviderAdapterFactory;
...
public class SimplemapDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	public static final String ID = "com.isb.simple.gmfmap.diagram"; //$NON-NLS-1$
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, SimplemapDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, SimplemapDiagramEditorPlugin.ID,
