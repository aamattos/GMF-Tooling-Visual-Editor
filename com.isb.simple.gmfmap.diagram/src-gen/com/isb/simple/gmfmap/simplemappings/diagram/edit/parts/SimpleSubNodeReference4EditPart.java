...
import com.isb.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleSubNodeReference4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SimpleSubNodeReference4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SimpleSubNodeReference4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimpleSubNodeReference4ItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplemapParserProvider
					.getParser(
							SimplemapElementTypes.SimpleSubNodeReference_3020,
							getParserElement(),
							SimplemapVisualIDRegistry
									.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleSubNodeReference4EditPart.VISUAL_ID));
		}
		return parser;
	}
