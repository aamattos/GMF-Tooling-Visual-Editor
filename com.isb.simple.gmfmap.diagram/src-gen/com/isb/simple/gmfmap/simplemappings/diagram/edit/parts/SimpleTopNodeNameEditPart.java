 ...
 * @generated
 */
public class SimpleTopNodeNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
			...
			parser = SimplemapParserProvider
					.getParser(
							...
							SimplemapVisualIDRegistry
									.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleTopNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
