...
import com.isb.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleSubNodeReferenceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SimpleSubNodeReferenceEditPart extends CompartmentEditPart
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplemapParserProvider
					.getParser(
							SimplemapElementTypes.SimpleSubNodeReference_3011,
							getParserElement(),
							SimplemapVisualIDRegistry
									.getType(com.isb.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleSubNodeReferenceEditPart.VISUAL_ID));
		}
		return parser;
	}
