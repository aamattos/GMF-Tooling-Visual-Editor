 ...
 * <ul>
 *   <li>{@link com.isb.simple.gmfmap.simplemappings.SimpleCompartment#getCompartmentMapping <em>Compartment Mapping</em>}</li>
 *   <li>{@link com.isb.simple.gmfmap.simplemappings.SimpleCompartment#getName <em>Name</em>}</li>
 *   <li>{@link com.isb.simple.gmfmap.simplemappings.SimpleCompartment#getCompartment <em>Compartment</em>}</li>
 *   <li>{@link com.isb.simple.gmfmap.simplemappings.SimpleCompartment#getCompartmentLabel <em>Compartment Label</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.isb.simple.gmfmap.simplemappings.SimplemappingsPackage#getSimpleCompartment()
 * @model
 * @generated
 */
public interface SimpleCompartment extends SimpleParentNode, SimpleChildNode {
	 ...
	 * @see com.isb.simple.gmfmap.simplemappings.SimplemappingsPackage#getSimpleCompartment_CompartmentMapping()
	 * @model derived="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link com.isb.simple.gmfmap.simplemappings.SimpleCompartment#getCompartmentMapping <em>Compartment Mapping</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.isb.simple.gmfmap.simplemappings.SimplemappingsPackage#getSimpleCompartment_Compartment()
	...
	/**
	 * Returns whether the value of the '{@link com.isb.simple.gmfmap.simplemappings.SimpleCompartment#getCompartment <em>Compartment</em>}' reference is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.isb.simple.gmfmap.simplemappings.SimplemappingsPackage#getSimpleCompartment_CompartmentLabel()
	 * @model unsettable="true" changeable="false" derived="true"
	 * @generated
	 */
	...
	/**
	 * Returns whether the value of the '{@link com.isb.simple.gmfmap.simplemappings.SimpleCompartment#getCompartmentLabel <em>Compartment Label</em>}' reference is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
