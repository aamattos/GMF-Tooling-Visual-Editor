 ...
 * @generated
 */
public class SimpleChildReferenceEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimpleChildReferenceItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplemapParserProvider
					.getParser(
							SimplemapElementTypes.SimpleChildReference_2004,
							getParserElement(),
							SimplemapVisualIDRegistry
									.getType(org.msl.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleChildReferenceEditPart.VISUAL_ID));
		}
		return parser;
	}
