...
import org.msl.simple.gmfmap.simplemappings.diagram.edit.policies.SimpleSubNodeReference3ItemSemanticEditPolicy;
...
public class SimpleSubNodeReference3EditPart extends CompartmentEditPart
			...
			parser = SimplemapParserProvider
					.getParser(
							...
							SimplemapVisualIDRegistry
									.getType(org.msl.simple.gmfmap.simplemappings.diagram.edit.parts.SimpleSubNodeReference3EditPart.VISUAL_ID));
		}
		return parser;
	}
	 ...
	 * @generated not
	 */
	public class SimpleTopNodeReferenceFigure extends
			WrappingLabelWithColorIcon {
