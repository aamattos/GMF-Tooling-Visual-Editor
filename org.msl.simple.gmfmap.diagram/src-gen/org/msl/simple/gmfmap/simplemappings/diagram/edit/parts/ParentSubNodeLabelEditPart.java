 ...
 * @generated
 */
public class ParentSubNodeLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				SimplemapVisualIDRegistry
						.getType(org.msl.simple.gmfmap.simplemappings.diagram.edit.parts.ParentSubNodeLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ParentSubNodeLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SimplemapTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new SimpleMappingEditPart.LinkLabelDragPolicy());
	}
	...
	protected IFigure createFigurePrim() {
		return new ParentSubNodeLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ParentSubNodeLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ParentSubNodeLabelFigure() {
			this.setText("<<parent>>");
		}
